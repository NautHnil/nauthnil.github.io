  ...
  (function($) {
    $.fn.html5lightbox = function(options) {
      ...
      inst.options = $.extend({
        ...
        shownavcontrol: true,
        navcontrolimage: "../../images/html5lightbox/lightbox-navcontrol.png",
        ...
        fadespeed: 400,
        jsfolder: jsFolder,
        skinsfoldername: "../../images/html5lightbox/",
      ...
      inst.resetDiv = function() {
        if (inst.elemArray.length > 0 && inst.options.curElem >= 0)
          if (inst.elemArray[inst.options.curElem][ELEM_TYPE] == 10) {
            var divID = inst.elemArray[inst.options.curElem][ELEM_HREF];
            if ($(divID).length > 0) $("#html5lightbox-div").children().appendTo($(divID))
          }
      };
      inst.reset = function() {
        ...
        if (inst.options.titlestyle == "bottom" ||
          inst.options.titlestyle == "inside") inst.$elemData.hide();
